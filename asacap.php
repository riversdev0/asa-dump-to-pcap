...
if ($_SERVER['REQUEST_METHOD']=="POST") {
  ...
  if (isset($_POST['capbytes'])) {
    ...
    if (strlen($_POST['capbytes']) > 500000) {
      die ("The textarea only accepts 500,000 characters. Please submit a smaller section of capture, or modify the script to accomodate more.");
    }
  ...
  echo "<html><body style=\"font-family:Verdana,Geneva,Tahoma,Arial;font-size:.9em;\">\n".
    ...
    "from an ASA and converts it into a pcap file. The box below accepts 500,000 characters. Paste in the output and then click ".
    ...
    "<div style=\"margin-bottom:15px;\"><textarea name=\"capbytes\" cols=\"95\" rows=\"26\" maxlength=\"500000\"></textarea></div>".
    "<input type=\"submit\" />\n".
    "</form>\n".
    "</body></html>";
}
